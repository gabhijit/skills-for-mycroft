...
class ZomatoFoodSkill(MycroftSkill):
	...
	headers = {'Accept': "application/json",'user-key': "<YourUserKey>"}
...
#response = curl -X GET --header "Accept: application/json" --header "user-key: <YourUserKey>" "https://developers.zomato.com/api/v2.1/categories"
